...
# UNTAPPD API KEYS
UNTAPPD_CLIENT_ID = "FE16B46AD5A1248F6033553BE89BFDCC540A3BD8"
UNTAPPD_SECRET_ID = "2A3A4B42C64E8BA299F6876512C5B20628308627"

# API ENDPOINTS
UNTAPPD_USER_FEED = "https://api.untappd.com/v4/user/checkins/theendallbeerall?client_id=" + UNTAPPD_CLIENT_ID + "&client_secret=" + UNTAPPD_SECRET_ID
UNTAPPD_USER_INFO = "https://api.untappd.com/v4/user/info/theendallbeerall?client_id=" + UNTAPPD_CLIENT_ID + "&client_secret=" + UNTAPPD_SECRET_ID
